...
import data.Save;
	...
	public class LibraryDraw extends JPanel{
		...
		public LibraryDraw(Character c[]) {
			...
			System.out.println("compcount:"+Compcount);
			System.out.println("Save.cl:"+Save.cl);
			Comprate= (Compcount*100)/Save.cl;
			System.out.println("comprate:"+Comprate);
			
			System.out.println("FriendShip:"+FriendShip[0]);
		...
		//Image HeartSpace = Toolkit.getDefaultToolkit().getImage("img/HeartSpace.png");
