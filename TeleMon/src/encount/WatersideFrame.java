...
public class WatersideFrame extends JFrame implements ActionListener {
	...
	public WatersideFrame(Character c[], Bait b[]) {
	...
	public void OpenWaterside(int rand) {
		randomvalue = rand;
		try {
		...
		this.setTitle("êÖï”ÉGÉäÉA");
		this.setDefaultCloseOperation(EXIT_ON_CLOSE);
		this.setSize(480, 620);
		this.setLocationRelativeTo(null);
		this.setResizable(false);

		WatersideLayout WL = new WatersideLayout(ch[rand].getName());
		WL.setBounds(0, 0, 480, 620);
